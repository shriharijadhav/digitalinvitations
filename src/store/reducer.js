...
export const reducer = (state=initialState,action)=>{
    switch (action.type) {
        ...
        case C_TOGGLE_ADD_INVITER_DETAILS:
            return{
                ...state,tempNewCardData:{...state.tempNewCardData,addInviterDetails:action.payload,inviterDetails:{
                    firstName:'',
                    lastName:'',
                    email:'',
                    contactNumber:'',
        ...
        case C_HANDLE_CHANGE_INVITER_DETAILS:

        return{
            ...state,tempNewCardData:{...state.tempNewCardData,inviterDetails:{...state.tempNewCardData.inviterDetails,[action.fieldName]:action.payload}}   
        }

        break;
        

        // cases for live card starts

        case SAVE_LIVE_CARD_DETAILS:

        return {
            ...state,liveCardData:action.payload
        }
        ...
        // cases for live card ends



        // cases for preview card starts
        case SET_CARD_PREVIEW_DATA:
        return{
            ...state,previewCardData:state.tempNewCardData
        }
        break;
