...
import { checkEmailValidity, checkFirstNameValidity, checkLastNameValidity, checkPasswordValidity, login, matchPasswords, selectLoginForm, selectSignUpForm, signup, toggleShowPassword, updateLoginFormData } from '../../store/actions'
...
const Login = () => {
    ...
    const isLoginSuccessful = useSelector((store) => store.isLoginSuccessful);
    const isLoginFailed = useSelector((store) => store.isLoginFailed);
    ...
    },[email,firstName,lastName,password,confirmPassword,isProceedToAccountVerification,isLoginSuccessful,isLoginFailed])
