 ...
 const MySlider = () => {
  ...
  return (
    <Flex position={'absolute'} w={'100%'} h={'100%'}>
      ...
      >
      <SwiperSlide>
        <Flex h={'100%'}  backgroundImage={"url('https://images.unsplash.com/photo-1425421640640-64c4debea1b4?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')"} >  </Flex>
      </SwiperSlide>
       <SwiperSlide>
