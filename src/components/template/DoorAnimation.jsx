  ...
  return (
    ...
    >
      <Flex w="100%" h="70%">
        ...
        <Flex  rounded={'full'} outline={'7px solid white'} w="400px" h="400px" bg="purple.300" direction={'column'} gap={'20px'} justifyContent={'center'} alignItems={'center'} textAlign={'center'} p={'40px 40px'}>
