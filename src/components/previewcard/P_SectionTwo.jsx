...
import P_BrideOrGroom from './P_BrideOrGroom'
import P_CountdownTimer from './P_CountdownTimer'
...
const P_SectionTwo = () => {
  ...
  return (
    <Flex w={'100%'} bg={'white'}  color={'black'} justifyContent={'center'} alignItems={'center'} >
        <Flex w={['90%','90%','80%','80%']} direction={'column'} justifyContent={'center'} alignItems={'center'} p={'40px 0px'}>
            <Flex w={'100%'} direction={priorityBetweenBrideAndGroom === 'bride'?['column','column','row','row']:['column-reverse','column-reverse','row-reverse','row-reverse']} justifyContent={'center'} p={'30px 0px'} gap={'30px'} alignItems={'center'}>
                <Flex  w={'100%'}>
                    <P_BrideOrGroom person={'Bride'} fullName={`${brideFirstName} ${brideLastName}`} socialLinkArray={brideSocialLinkArray} actualImage={brideActualImage}/>
                </Flex>
                ...
                <Flex  w={'100%'}>
                    <P_BrideOrGroom person={'Groom'} fullName={`${groomFirstName} ${groomLastName}`} socialLinkArray={groomSocialLinkArray}   actualImage={groomActualImage}/>
                </Flex>
            </Flex>
             <Flex w={'100%'}  justifyContent={'center'} alignItems={'center'}>
                <P_CountdownTimer targetDateTime={targetDateTime} />
            </Flex>
        </Flex>
    </Flex>
  )
