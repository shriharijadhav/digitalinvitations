...
const P_Gallery = () => {
    ...
    const images = previewCardData?.photoGallery
        ...
        <Grid m={'auto'} w={'100%'} templateColumns={["repeat(1,1fr)","repeat(2,1fr)","repeat(2,1fr)","repeat(3,1fr)"]} gap={6}>
          {images.map((src, index) => (
            <Box
              ...
              backgroundImage={`url(${URL.createObjectURL(src)})`}
        ...
        <Modal isOpen={isOpen} onClose={onClose} size="full">
          ...
          <ModalContent bg="blackAlpha.800">
            ...
            <ModalBody display="flex" alignItems="center" justifyContent="center">
              ...
              <Image src={URL.createObjectURL(images[currentIndex])} maxH="80vh" maxW="80vw" />
              <IconButton
                icon={<ArrowRightIcon />}
                onClick={nextImage}
                position="absolute"
